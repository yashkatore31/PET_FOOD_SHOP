...
<html lang="en">
	<head>
	    ...
	    <title>PET'S BUDDY Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item"  >
			<a href="#" class="image">
						<img data-echo="assets/images/sliders/sld.jpeg" src="assets/images/sliders/sld.jpeg" alt="" width="auto" height="360">
					</a>
			
			<!-- style="background-image: url(assets/images/sliders/sld.jpeg);"-->
				<!-- /.container-fluid -->
			</div><!-- /.item -->
	    ...
	    <div class="full-width-slider">
			...
			<a href="#" class="image">
						<img data-echo="assets/images/sliders/slider1.jpeg" src="assets/images/sliders/slider1.jpeg" alt="" width="auto" height="360">
					</a>

				<!-- style="background-image: url(assets/images/sliders/slider1.jpeg);" -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over Rs. 200.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">All products-sale up to 20% off </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">DOG </a></li>
					<li><a href="#furniture" data-toggle="tab">CAT</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
